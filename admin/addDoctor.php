...
// upload image
  ...
  if(isset($_FILES['image']) && $_FILES['image']['name'] !=''){
    ...
    $stmt2 = $con->prepare('INSERT INTO `doctors` ( `name`, `specialty`, `waiting`, `about`, `image`) VALUES (?, ?, ?, ?, ?);');
    $stmt2->execute(array($name, $specialty, $waiting, $about, $image));
      ...
      <div class="w3-section">
        <div>
          ...
          <?php 
            ...
            <?php }
            if(isset($error)){?>
              <div style="color: #fff;padding: 10px;text-align: center;background: red;"><?php echo $error ?></div>
            <?php }
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']?>"  method="POST" enctype="multipart/form-data">
            ...
            <input  class="w3-input w3-border w3-margin-bottom"  type="text" placeholder="Enter Doctor Name" name="name" required><br>
            <label><b>Specialty</b></label>
            <input  class="w3-input w3-border w3-margin-bottom"  type="text" placeholder="Enter Doctor Specialty" name="specialty" required><br>
            <label><b>Waiting</b></label>
            <input  class="w3-input w3-border w3-margin-bottom"  type="text" placeholder="Enter Doctor Waiting" name="waiting" required><br>

            <label><b>About</b></label>
            <input  class="w3-input w3-border w3-margin-bottom"  type="text" placeholder="Enter Doctor about" name="about" required><br>
