...
// upload image
  ...
  if(isset($_FILES['image']) && $_FILES['image']['name'] !=''){
    ...
    $stmt2 = $con->prepare('INSERT INTO `hospitals` ( `name`, `location`, `image`) VALUES (?, ?, ?);');
    $stmt2->execute(array($name, $location, $image));
      ...
      <div class="w3-section">
        <div>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']?>"  method="POST" enctype="multipart/form-data">
            ...
            <input  class="w3-input w3-border w3-margin-bottom"  type="text" placeholder="Enter Hospital Name" name="name" required><br>
            <label><b>Location</b></label>
            <input  class="w3-input w3-border w3-margin-bottom"  type="text" placeholder="Enter Hospital location" name="location" required><br>
